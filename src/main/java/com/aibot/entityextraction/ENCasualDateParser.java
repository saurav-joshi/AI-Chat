...
public class ENCasualDateParser extends ParserAbstract {

    private static String regPattern = "(?<=\\W|^)"
            + "(today|tonight|dinner|tomorrow|tmr|yesterday|last\\s*night|this\\s*(morning|afternoon|evening))"
            + "(?=\\W|$)";
    ...
    protected ParsedResult extract(String text, Date refDate, Matcher matcher, ChronoOption option) {
        ...
        if (firstMatch.equals("tonight")||firstMatch.equals("dinner")) {
